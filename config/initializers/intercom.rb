IntercomRails.config do |config|
  # == Intercom app_id
  #
  config.app_id = ENV["INTERCOM_APP_ID"] || "tueqthiq"
  ...
  config.user.custom_data = {
     :experience_count => Proc.new { |current_user| current_user.experiences.count },
     :segment_count => Proc.new { |current_user| current_user.segments.count }
  }
  ...
  #
  config.company.current = Proc.new { @organization }
