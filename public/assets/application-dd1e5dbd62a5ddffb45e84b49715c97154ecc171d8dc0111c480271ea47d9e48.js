...
/*!
 * Generated using the Bootstrap Customizer (http://getbootstrap.com/customize/?id=37d8dcd2f08329e49fb21b9e60fe79d4)
 * Config saved to config.json and https://gist.github.com/37d8dcd2f08329e49fb21b9e60fe79d4
 */
...
$( document ).ready( function() {
  ...
  $('.js-group-toggle').click(function() {
...
$( document ).ready( function() {
  ...
  $('#new_invite').on('ajax:success', function( xhr, data, response ) {
    ...
    $('input:text').val('');
    $('.invite-message-container').html('Invite Sent Successfully!');
  }).on('ajax:error', function(xhr, data, response) {
    var errors = JSON.parse( data.responseText ).errors;
  ...
  $('#add_shadowers_to_experience').on('ajax:success', function( xhr, data, response ) {
    $('.add-shadower-message-container').html('Shadowers Added Successfully!');
  }).on('ajax:error', function(xhr, data, response) {
    var errors = JSON.parse( data.responseText ).errors;
